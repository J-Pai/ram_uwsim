...
if("TRUE" STREQUAL "TRUE")
  set(underwater_vehicle_dynamics_SOURCE_PREFIX /home/user/ram_uwsim/src/underwater_simulation/underwater_vehicle_dynamics)
  set(underwater_vehicle_dynamics_DEVEL_PREFIX /home/user/ram_uwsim/devel)
  ...
  set(underwater_vehicle_dynamics_INSTALL_PREFIX /home/user/ram_uwsim/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'underwater_vehicle_dynamics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/ram_uwsim/src/underwater_simulation/underwater_vehicle_dynamics/${idir}'.  Ask the maintainer 'Mario Prats <marioprats@gmail.com>, Javier Perez <perezsolerj@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${underwater_vehicle_dynamics_dep}_FOUND)
      find_package(${underwater_vehicle_dynamics_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${underwater_vehicle_dynamics_dep} REQUIRED ${depend_list})
  endif()
