...
if("TRUE" STREQUAL "TRUE")
  set(uwsim_SOURCE_PREFIX /home/user/ram_uwsim/src/underwater_simulation/uwsim)
  set(uwsim_DEVEL_PREFIX /home/user/ram_uwsim/devel)
  set(uwsim_INSTALL_PREFIX "")
  set(uwsim_PREFIX ${uwsim_DEVEL_PREFIX})
else()
  set(uwsim_SOURCE_PREFIX "")
  set(uwsim_DEVEL_PREFIX "")
  set(uwsim_INSTALL_PREFIX /home/user/ram_uwsim/install)
...
if(NOT "/home/user/ram_uwsim/src/underwater_simulation/uwsim/include " STREQUAL " ")
  set(uwsim_INCLUDE_DIRS "")
  set(_include_dirs "/home/user/ram_uwsim/src/underwater_simulation/uwsim/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uwsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/ram_uwsim/src/underwater_simulation/uwsim/${idir}'.  Ask the maintainer 'Mario Prats <marioprats@gmail.com>, Javier Perez <perezsolerj@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${uwsim_dep}_FOUND)
      find_package(${uwsim_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${uwsim_dep} REQUIRED ${depend_list})
  endif()
